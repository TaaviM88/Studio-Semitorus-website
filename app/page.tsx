...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      {/* Hero Section */}
    <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-green-700 via-purple-900 to-gray-900">
    {/* Green ooze effect on left and right */}
    <div className="absolute top-0 left-0 w-8 h-full bg-gradient-to-b from-green-500 to-transparent opacity-70 animate-pulse"></div>
    <div className="absolute top-0 right-0 w-8 h-full bg-gradient-to-b from-green-500 to-transparent opacity-70 animate-pulse"></div>
      ...
      <section className="py-20 bg-gray-800">
        ...
        <div className="bg-gray-700 rounded-lg overflow-hidden shadow-lg transition transform hover:scale-105">
            ...
            <div className="p-6">
                ...
                <a 
                href="https://store.steampowered.com/app/2736890/False_Hope/" 
                target="_blank" 
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="bg-gray-800 h-80 rounded-lg flex items-center justify-center overflow-hidden">
            <Image 
                src="/company/studioSemitorus_logo.png" 
                alt="Studio Semitorus Logo" 
                width={300} 
